...
<head>
    ...
    <title>Shipper Login - Delivery Partner</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 min-h-screen flex items-center justify-center">
    ...
    <div class="relative w-full max-w-md">
        <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
            <div class="mb-8">
                ...
                <p class="text-center text-gray-300 text-sm">Shipper Login</p>
            </div>

            <form class="space-y-5" action="/SHooad/public/shipper/login" method="POST">
                <div>
                    <label class="block text-sm font-medium text-gray-200 mb-2">Email</label>
                    <input name="email" type="email" placeholder="your@email.com" class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-200 mb-2">Password</label>
                    <input name="password" type="password" placeholder="••••••••" class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition">
                </div>
            ...
            <div class="mt-6 pt-6 border-t border-white/20">
                <p class="text-center text-gray-300 text-sm">
                    ...
                    <a href="signup" class="text-blue-400 hover:text-blue-300 font-semibold transition">Sign up here</a>
                </p>
            </div>
        </div>
    </div>
