...
<head>
    ...
    <title>Reset Password - Seller Dashboard</title>
...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Email: <strong><?= htmlspecialchars($data['email'] ?? '') ?></strong></p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
            ...
            <form method="POST" action="/SHooad/public/seller/reset-password">
