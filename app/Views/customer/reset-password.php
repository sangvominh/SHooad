...
<head>
    <meta charset="UTF-8">
    <title>Reset Password | SHooad</title>
...
<body>
    ...
    <div class="relative z-10 bg-white p-8 rounded-2xl shadow-2xl w-[90vw] max-w-md">
        ...
        <p class="text-center text-gray-600 mb-6 text-sm">
            Email: <strong><?= htmlspecialchars($data['email'] ?? '') ?></strong>
        </p>
        ...
        <form action="/SHooad/public/customer/reset-password" method="POST" class="space-y-4">
