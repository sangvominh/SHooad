<nav class="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-md">
    <?php
    ...
    <div class="w-full">
        <div class="container mx-auto px-2 md:px-4">
            ...
            <li class="relative group shrink-0">
                ...
                <div class="absolute left-0 mt-0 w-64 max-h-[70vh] overflow-y-auto bg-white text-gray-800 rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40">
                    <div class="py-2">
            ...
            <li class="relative group shrink-0">
                ...
                <div class="absolute left-0 mt-0 w-56 bg-white text-gray-800 rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40">
                    <div class="py-2">
            ...
            <li class="relative group shrink-0 hidden xl:block">
                ...
                <div class="absolute left-0 mt-0 w-52 bg-white text-gray-800 rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40">
                    <div class="py-2">
