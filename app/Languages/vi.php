...
return [
    ...
    'orders' => [
        ...
        'order_cancelled_msg' => 'Đơn hàng #{order_id} của bạn đã được hủy thành công.',
        'refund_msg' => 'Tiền đã được hoàn lại vào tài khoản của bạn.',
        'refund_note' => 'Vui lòng kiểm tra tài khoản ngân hàng trong vòng 1-3 ngày làm việc.',
        'got_it' => 'Đã hiểu',
    ],
    ...
    'order_success' => [
        ...
        'thank_you' => 'Cảm ơn bạn đã đặt hàng tại SHooad',
        'order_code' => 'Mã đơn hàng',
        'order_received' => 'Chúng tôi đã nhận được đơn hàng của bạn và sẽ xử lý trong thời gian sớm nhất. Bạn sẽ nhận được email xác nhận đơn hàng ngay lập tức.',
    ...
    'cart' => [
        ...
        'discount' => 'Giảm giá',
        'add_to_cart_success' => 'Đã thêm vào giỏ hàng thành công!',
    ...
    'product' => [
        ...
        'description' => 'Mô tả',
        'description_title' => 'Mô tả sản phẩm',
        'price' => 'Giá',
        'in_stock' => 'Còn hàng',
        ...
        'buy_now' => 'Mua ngay',
        'reviews' => 'Đánh giá',
        'reviews_title' => 'Đánh giá sản phẩm',
        'no_reviews' => 'Chưa có đánh giá nào',
        'no_reviews_yet' => 'Chưa có đánh giá. Hãy là người đầu tiên đánh giá sản phẩm này!',
        'rating' => 'Xếp hạng',
        ...
        'size' => 'Kích thước',
        'quantity' => 'Số lượng',
        'stock_remaining' => 'Còn :count sản phẩm',
        'star' => 'sao',
    ],
